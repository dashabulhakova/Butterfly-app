...
class RecentMessageCell: LBTAListCell<RecentMessage> {
    ...
    let usernameLabel = UILabel(text: "ІМ'Я КОРИСТУВАЧА", font: .boldSystemFont(ofSize: 18))
    let messageTextLabel = UILabel(text: "Текст повідомлення", font: .systemFont(ofSize: 16), textColor: .gray, numberOfLines: 2)
