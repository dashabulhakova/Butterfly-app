...
class HomeController: UIViewController, SettingsControllerDelegate, LoginControllerDelegate, CardViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        // When the user logs out on settings controller, present the login controller
    ...
    fileprivate func fetchCurrentUser() {
        self.hud.textLabel.text = "Завантаження"
    ...
    fileprivate func fetchUsersFromFirestore() {
        ...
        //provide default min and max seeking age otherwise loading indicator is shown for infinite duration
        let minAge = user?.minSeekingAge ?? SettingsController.defaultMinSeekingAge
        let maxAge = user?.maxSeekingAge ?? SettingsController.defaultMaxSeekingAge

        // limit the number of users at one to fasten the performance
