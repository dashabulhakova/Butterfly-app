...
class CustomInputAccessoryView: UIView {
    ...
    let sendButton = UIButton(title: "ВІДПРАВИТИ", titleColor: .black, font: .boldSystemFont(ofSize: 14), target: nil, action: nil)

    let placeholderLabel = UILabel(text: "Написати повідомлення", font: .systemFont(ofSize: 16), textColor: .lightGray)
