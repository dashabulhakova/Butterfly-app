...
class MatchesMessagesViewNavBar: UIView {
    ...
    override init(frame: CGRect) {
        ...
        iconImageView.tintColor = #colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)
        let messagesLabel = UILabel(text: "Повідомлення", font: .boldSystemFont(ofSize: 20), textColor: #colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1), textAlignment: .center)
        let feedLabel = UILabel(text: "Стрічка", font: .boldSystemFont(ofSize: 20), textColor:.gray, textAlignment: .center)
